...
read -p "Building and pushing version '$TAG'. Are you sure? (y/n) " yn
...
docker buildx build --push --platform linux/arm/v7,linux/amd64 ./source -t bemcom/modbus-tcp-connector:$TAG