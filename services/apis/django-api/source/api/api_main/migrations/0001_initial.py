    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.TextField(blank=True, default=None, help_text='A short name to identify the datapoint.', max_length=30, null=True, unique=True)),
                ...
                ('last_value', models.JSONField(blank=True, default=None, help_text='The last value received for the datapoint. We store all values including numeric as strings as this simplfies the logic significantly and prevents unintended side effects, e.g. data loss if the data format field is changed.', null=True)),
                ...
                ('key_in_connector', models.TextField(help_text='Internal key used by the connector to identify the datapoint in the incoming/outgoing data streams.')),
                ('type', models.CharField(default=None, help_text='Datapoint type, can be ether sensor or actuator. Is defined by the connector.', max_length=8)),
                ('example_value', models.JSONField(editable=False, help_text='One example value for this datapoint. Should help admins while mangeing datapoints, i.e. to specify the correct data format.', null=True)),
                ('connector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_main.connector')),
            ],
        ),
        migrations.CreateModel(
            name='DatapointValue',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(default=None, help_text='For sensor datapoints: The time the value was received by the connector.\nFor actuator datapoints: The time the message was created by the external entity.\nBoth in milliseconds since 1970-01-01 UTC.')),
                ('value', models.JSONField(blank=True, default=None, help_text='The value part of the DatapointValue message.', null=True)),
