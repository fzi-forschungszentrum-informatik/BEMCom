...
if settings.ACTIVATE_CONTROL_EXTENSION:
    ...
    class ControllerAdmin(admin.ModelAdmin):
        ...
        list_display = ("id", "name", "mqtt_topic_controlled_datapoints")
    ...
    class ControlledDatapoint(admin.ModelAdmin):
        ...
        search_fields = ["sensor_datapoint", "actuator_datapoint"]
        autocomplete_fields = ["sensor_datapoint", "actuator_datapoint"]
