# Generated by Django 2.2.5 on 2020-01-13 10:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mqtt_topic', models.TextField(blank=True, editable=False, help_text='The MQTT topic on which the values of this datapoint are published. Is auto generated for consistency.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mqtt_topic', models.TextField(blank=True, editable=False, help_text='The MQTT topic on which the values of this datapoint are published. Is auto generated for consistency.', null=True)),
                ('datapoint_key_in_connector', models.TextField(default='')),
                ('last_value', models.TextField(blank=True, default='', help_text='The last value django is aware of. This is used as an initial value in pages before updating from MQTT.')),
                ('last_timestamp', models.BigIntegerField(default=None, help_text='The last timestamp corresponding to last_value above. This is used as an initial value in pages before updating from MQTT.', null=True)),
